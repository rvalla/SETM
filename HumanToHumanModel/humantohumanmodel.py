...
testingASResponse = 0.03 #The probability for a asymptomatic human of being tested by the government each day
...
for i in range(simulationsCount):
	...
	if i == 0:
		dt.saveConfigStart(simulationsPopulation, simulationsPeriod, simulationName, runGovActions, \
			govActions, govFailureList, autoIsolationThreshold, startingImmunity, psicosis, psicosisTrigger, \
