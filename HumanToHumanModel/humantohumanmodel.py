...
simulationsCount = 3
simulationsName = "31082020_5K_360d_Opt"
...
autoIsolationThreshold = 0.4 # [0,1] The probability of a human will auto-isolate himself when having symptoms
...
infoFactor = 1.15 # (1, inf) Value to represent government awareness campaigns
socialDistanceFactor = 1.25 # (1,inf) Value to represent control of social distance
isolationFactor = 1.42 # (1,inf) Value to reduce number of human contacts
exchangeFactor = 2.0 # (1,inf) Value to reduce human interchange between urban areas
