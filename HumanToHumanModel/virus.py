baseInfectionThreshold = 0.10 #How contagious the virus is
...
immunityPeriod = 75 #Days of immunity after an infection
reinfectionFactor = 1.25 #Control the power of disease in a reinfected human
...
class Virus():
	...
	def getReinfectionFactor(iNumber):
		if iNumber == 1:
			...
			f = pow(reinfectionFactor, iNumber - 1)
			return f
	...
	def saveSimulationConfig(simulationName):
		...
		virConfig.write("Days of immunity after cure: " + str(immunityPeriod) + "\n")
		virConfig.write("Virus reinfection factor: " + str(reinfectionFactor) + "\n")
